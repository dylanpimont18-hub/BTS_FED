...
Une résidence de 30 logements de 55\,m² chacun est située en zone climatique H1b (Lyon, température de base $T_{base} = -7$\,°C, $T_{int} = 19$\,°C). Le coefficient de déperdition moyen est $G = \SI{1{,}0}{\watt\per\square\metre\per\kelvin}$. Les besoins ECS représentent \SI{10}{\kilo\watt} en pointe. Le coefficient de foisonnement est 0,75.
...
\begin{itemize}
  ...
  \item PCI du gaz naturel : $\text{PCI} = \SI{10{,}33}{\kilo\watt\heure\per\cubic\metre}$
\end{itemize}
...
Un hôtel de 20 chambres à Marseille (zone H3) souhaite installer des capteurs solaires plans pour préchauffer l'ECS. Données :
\begin{itemize}
  ...
  \item Irradiance moyenne annuelle sur plan incliné 45°S à Marseille : $G_{an} = \SI{1800}{\kilo\watt\heure\per\square\metre\per\year}$
  ...
  \item Irradiance journalière moyenne à utiliser : $G_{moy} = \SI{5{,}0}{\kilo\watt\heure\per\square\metre\per\day}$
\end{itemize}
...
\]
\[
  \dot{Q}_{dep} = G \times S \times (T_{int} - T_{base}) = 1{,}0 \times 1650 \times (19 - (-7)) = 1{,}0 \times 1650 \times 26 = \SI{42\,900}{\watt} \approx \SI{42{,}9}{\kilo\watt}
\]

\[
  \boxed{\dot{Q}_{dep} \approx \SI{42{,}9}{\kilo\watt}}
\]

\textit{Question 2 — Puissance nécessaire :}
\[
  \dot{Q}_{total} = (\dot{Q}_{dep} + \dot{Q}_{ECS}) \times \frac{1}{foisonnement} = (42{,}9 + 10) \times \frac{1}{0{,}75} = 52{,}9 \times 1{,}333 \approx \SI{70{,}5}{\kilo\watt}
\]

\[
  \boxed{\dot{Q}_{total} \approx \SI{70{,}5}{\kilo\watt}}
\]

\textit{Question 3 — Choix :} Avec une marge de sécurité de 10\,\%, la puissance minimale à installer est $70{,}5 \times 1{,}10 \approx \SI{77{,}6}{\kilo\watt}$. Le modèle X (\SI{60}{\kilo\watt}) est insuffisant. Le modèle Y (\SI{80}{\kilo\watt}) couvre juste les besoins (80 > 77,6) mais laisse une marge faible. Le \textbf{modèle Z (\SI{100}{\kilo\watt})} est retenu pour offrir une marge opérationnelle confortable (42\,\%) permettant d'absorber un pic ECS simultané sans dégradation.
...
Économie en énergie :
\[
  \Delta E = 85\,000 \times \frac{5{,}8}{77{,}5} \approx \SI{6\,355}{\kilo\watt\heure_{\text{PCI}} \per\year}
\]
...
\[
  Q_{an} = Q_j \times 365 = 26{,}2 \times 365 = \boxed{\SI{9\,563}{\kilo\watt\heure\per\year}}
\]
...
\[
  S = \frac{f \times Q_{an}}{G_{an} \times \eta_{cap} \times \eta_{sys}} = \frac{0{,}60 \times 9\,563}{1\,800 \times 0{,}694 \times 0{,}85}
\]
\[
  = \frac{5\,738}{1\,062{,}2} \approx \boxed{5{,}4\,\text{m}^2}
\]
...
\[
  V_{ballon} = 50 \text{ à } 80\,\text{L/m}^2 \times 5{,}4\,\text{m}^2 = 270 \text{ à } 430\,\text{L}
\]
\[
  \boxed{V_{ballon} \approx 300 \text{ à } 400\,\text{L}}
\]
...
\[
  E_{sol} = f \times Q_{an} = 0{,}60 \times 9\,563 = \SI{5\,738}{\kilo\watt\heure\per\year}
\]
...
\[
  I = S \times 850 = 5{,}4 \times 850 = \SI{4\,590}{\euro}
\]
(On retient $S = 5{,}4\,\text{m}^2$ pour le calcul ; en pratique l'investissement sera basé sur la surface réellement posée.)

\[
  TRI = \frac{I}{\Delta C} = \frac{4\,590}{606} \approx \boxed{7{,}6\,\text{ans}}
\]

\begin{methode}
Ce TRI de 7 à 8 ans est typique pour une installation solaire thermique en zone méditerranéenne. Les aides MaPrimeRénov' Copropriété ou les CEE peuvent réduire l'investissement de 30 à 50\,\%, ramenant le TRI à 4--5 ans. En zone H1 (Paris), l'irradiance plus faible allonge le TRI à 10--12 ans sans aides.
\end{methode}
