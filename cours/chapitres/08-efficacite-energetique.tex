...
\]
avec $f_{\text{nr,PAC}} \approx 0{,}60$ (fraction non renouvelable réglementaire PAC air/eau) :
\[
...
\begin{enumerate}
  ...
  \item Calculer le Cep,nr (\text{fep,nr} électricité VRV = 2,3 ; fraction non renouvelable éclairage = 1,0).
...
Chauffage :
\[
C_{\text{ef,ch}} = \frac{28\,000}{3{,}8 \times 0{,}97} = \frac{28\,000}{3{,}686} = \SI{7\,596}{\kWh \per \year}
\]

Refroidissement :
\[
C_{\text{ef,fr}} = \frac{15\,000}{3{,}2 \times 0{,}97} = \frac{15\,000}{3{,}104} = \SI{4\,833}{\kWh \per \year}
\]

Éclairage (consommation directe) : $C_{\text{ef,écl}} = \SI{8\,000}{\kWh \per \year}$

Auxiliaires : $C_{\text{aux}} = \SI{4\,500}{\kWh \per \year}$

Total énergie finale : $C_{\text{ef,total}} = 7\,596 + 4\,833 + 8\,000 + 4\,500 = \SI{24\,929}{\kWh \per \year}$

\medskip
\textbf{2. Cep (toute l'électricité, fep = 2,3) :}
\[
\text{Cep} = \frac{24\,929 \times 2{,}3}{500} = \frac{57\,337}{500} = \SI{114{,}7}{\kWh_{ep} \per \m^2 \per \year}
\]

\medskip
\textbf{3. Cep,nr :}

En première approche simplifiée (tout en électricité) :
\[
\text{Cep,nr} = \frac{(7\,596 + 4\,833) \times 2{,}3 \times 0{,}55 + (8\,000 + 4\,500) \times 2{,}3 \times 1{,}0}{500}
\]
\[
= \frac{12\,429 \times 1{,}265 + 12\,500 \times 2{,}3}{500} = \frac{15\,722 + 28\,750}{500} = \frac{44\,472}{500} = \SI{88{,}9}{\kWh_{ep,nr} \per \m^2 \per \year}
\]
...
La puissance de chauffage liée à la ventilation (simple flux) :
\[
\dot{m}_{\text{air}} = \frac{3\,200}{3\,600} \times 1{,}2 = \SI{1{,}067}{\kg \per \s}
\]

Le besoin annuel (méthode DJU) :
\[
Q_{\text{vent,SF}} = \dot{m}_{\text{air}} \times c_p \times \text{DJU} \times 86\,400 \times \frac{1}{3\,600\,000}
\]
\[
= 1{,}067 \times 1\,006 \times 2\,130 \times 86\,400 / 3\,600\,000 = \SI{55\,285}{\kWh \per \year}
\]

Ou de manière équivalente avec $\text{DJU} \times 24$ en K.h :
\[
Q_{\text{vent,SF}} = 1{,}067 \times 1\,006 \times (2\,130 \times 24) / 1\,000 = 1{,}073 \times 51\,120 / 1\,000 = \SI{54\,852}{\kWh \per \year}
\]
...
\[
\Delta E = \frac{46\,624}{0{,}95} \times 0{,}10 = \frac{46\,624}{0{,}95} \times 0{,}10 = \SI{4\,908}{\euro \per \year}
\]

\textbf{3. Temps de retour sur investissement :}
\[
T_{\text{retour}} = \frac{18\,000}{4\,908} \approx \textbf{3{,}7 ans}
\]

Ce temps de retour est excellent (inférieur à 5 ans), ce qui justifie pleinement l'investissement dans le double flux avec récupération.
