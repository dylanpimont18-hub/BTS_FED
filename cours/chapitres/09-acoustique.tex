...
\begin{enumerate}
  ...
  \item Proposer une solution constructive et vérifier sa conformité à partir du tableau de $R_w$.
...
Une CTA double flux dessert 8 bureaux individuels (exigence NC 30). Les données constructeur de la CTA sont : $L_w = 78$~dB (global) ; le réseau aéraulique assure une atténuation de 15~dB ; les bouches de soufflage ont un niveau NC 28 pour le débit nominal.
