...
Un immeuble de logements à Lyon (zone H2b, $T_{ext,base} = \SI{-8}{\celsius}$) est chauffé par des radiateurs à basse température ($T_{dep,max} = \SI{55}{\celsius}$ à $T_{ext,base}$). Le chauffage se coupe à $T_{ext} = \SI{16}{\celsius}$ ($T_{dep,min} = \SI{30}{\celsius}$).
...
Un immeuble de bureaux de \SI{2000}{\metre\squared} (SHON) consomme actuellement $85\,\text{kWh}_{\text{ef}}/\text{m}^2/\text{an}$ en chauffage, climatisation et ECS. Il est classé GTB\,C (régulation basique). Une rénovation GTB vers la classe\,B est envisagée.
...
\begin{enumerate}
  ...
  \[
    T_{dep} = T_{dep,min} + K_{loi} \times (T_{ext,coupure} - T_{ext}) = 30 + 1{,}04 \times (16 - 2) = 30 + 14{,}6 \approx \boxed{\SI{45}{\celsius}}
  \]
...
\begin{enumerate}
  ...
  \[
    \text{Économie} = \Delta E \times p_{elec} = 404{,}4 \times 0{,}18 = \boxed{\SI{72.8}{\euro\per\an}}
  \]
\end{enumerate}
...
\begin{enumerate}
  ...
  \[
    ...
    \quad\Rightarrow\quad
    \text{Éco}_{\text{gaz}} = 19\,890 \times 0{,}095 = \SI{1889.6}{\euro\per\an}
  \]
  ...
  \[
    ...
    \quad\Rightarrow\quad
    \text{Éco}_{\text{elec}} = 10\,710 \times 0{,}18 = \SI{1927.8}{\euro\per\an}
  \]

  \textbf{Économie financière annuelle totale :}
  \[
    \text{Éco}_{tot} = 1\,889{,}6 + 1\,927{,}8 = \boxed{\SI{3817.4}{\euro\per\an}}
  \]
