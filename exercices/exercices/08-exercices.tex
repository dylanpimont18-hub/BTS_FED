...
Un appartement de \SI{75}{\m^2} à Strasbourg (zone H1c) construit en 1975 est diagnostiqué étiquette F (consommation conventionnelle : $320\,\text{kWh}_{ep}/\text{m}^2/\text{an}$). Le propriétaire envisage deux scénarios de rénovation pour atteindre l'étiquette C ($< 150\,\text{kWh}_{ep}/\text{m}^2/\text{an}$) :
\begin{itemize}
