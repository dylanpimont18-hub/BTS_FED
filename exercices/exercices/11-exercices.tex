...
Pour refroidir l'air de \SI{27}{\celsius} à \SI{15}{\celsius} (enthalpie sensible), la température d'entrée eau glacée doit être inférieure à la température de rosée de l'air traité. Avec un pincement de $\SI{4}{\celsius}$, $T_{EG,entrée} \leq 15 - 4 = \SI{11}{\celsius}$. On retient \textbf{\SI{7}{\celsius}} (circuit type \SI{6/12}{\celsius}).
